...
path = "______________/data mining project/"
import pandas as pd
import os
import re
import numpy as np
...
data = os.listdir(path + 'pre-processing/financial_statistics')

#append all files together
appended_data = []
for i in data:
    df = pd.read_csv(path + 'pre-processing/financial_statistics/'+i)
