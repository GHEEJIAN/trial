...
path = "__________________________/data mining project/"

#load data
a = pd.read_csv(path+"pre-processing/news/news_20190318.csv")
b = pd.read_csv(path+"pre-processing/news/news_20190327.csv")
c = pd.read_csv(path+"pre-processing/news/news_20190403.csv")
d = pd.read_csv(path+"pre-processing/news/news_20190410.csv")
e = pd.read_csv(path+"pre-processing/news/news_20190417.csv")
